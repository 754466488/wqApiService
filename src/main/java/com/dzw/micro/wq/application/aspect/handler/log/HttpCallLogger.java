...
/**
 * httpCall日志打印
 * 日志格式：应用名称|本机IP|httpCall|方法名称|入参|结果|耗时毫秒
 *
 * @author lyb
 * @date 2020/11/26
 */
@Component
@Order(99)
public class HttpCallLogger implements AspectHandler {
	@Autowired
	private LoggerHelper loggerHelper;

	@Override
	public AspectTypeEnum getAspectTypeEnum() {
		return AspectTypeEnum.HTTP_CALL;
	}
	...
	public Resp preHandle(AspectInfo aspectInfo) throws Throwable {
		...
		sb.append(AspectTypeEnum.HTTP_CALL.getName()).append(SymbolConstant.BAR);
