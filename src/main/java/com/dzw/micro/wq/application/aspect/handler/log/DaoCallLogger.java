...
/**
 * dao调用日志打印
 * 日志格式：应用名称|本机IP|dbCall或esCall|daoClassName.daoMethodName|入参|结果|耗时毫秒
 *
 * @author lyb
 * @date 2020/11/26
 */
@Component
@Order(99)
public class DaoCallLogger implements AspectHandler {
	@Autowired
	private LoggerHelper loggerHelper;

	@Override
	public AspectTypeEnum getAspectTypeEnum() {
		return AspectTypeEnum.DAO_CALL;
	}
	...
	public Resp preHandle(AspectInfo aspectInfo) throws Throwable {
		...
		sb.append(AspectTypeEnum.DAO_CALL.getName()).append(SymbolConstant.BAR);
