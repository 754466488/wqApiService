...
/**
 * mq生产日志打印
 * 日志格式：应用名称|本机IP|mqProduce|produceClassName.methodName|入参|结果|耗时毫秒
 *
 * @author lyb
 * @date 2020/11/26
 */
@Component
@Order(99)
public class MqProduceLogger implements AspectHandler {
	@Autowired
	private LoggerHelper loggerHelper;

	@Override
	public AspectTypeEnum getAspectTypeEnum() {
		return AspectTypeEnum.MQ_PRODUCE;
	}
	...
	public Resp preHandle(AspectInfo aspectInfo) throws Throwable {
		...
		sb.append(AspectTypeEnum.MQ_PRODUCE.getName()).append(SymbolConstant.BAR);
