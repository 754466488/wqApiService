...
import com.dzw.micro.wq.application.domain.exception.*;
...
public class Resp<T> implements Serializable {
	...
	public static <T> Resp error(String message, T data) {
		return new Resp(ErrorCode.OPER_FAIL.getCode(), message, data);
	}
