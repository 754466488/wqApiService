...
public class NewsDetailResp {
	...
	private Long upNewsId;
	@ApiModelProperty(value = "上一篇文章标题")
	private String upNewsTitle;
	@ApiModelProperty(value = "下一篇文章id")
	private Long downNewsId;
	@ApiModelProperty(value = "下一篇文章标题")
	private String downNewsTitle;
}
